...
export async function POST(
  ...
  try {
    ...
    // Only admin/manager can reject locations
    ...
    if (workLocation.status === "rejected" || !workLocation.isActive) {
      return jsonResponse({
        success: true,
        message: "Location already rejected",
        data: {
    ...
    return handleApiError("work-locations/reject", error);
  }
}
